...
But on second thought ... If it offends you to use simple workarounds for this chip's limited resources, then spend another $1 and buy one of the various STM32F103C8T6 / bluepill boards with 4 times the flash.
