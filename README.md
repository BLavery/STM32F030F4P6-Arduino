...
However, including calls in your sketch to arduino's regular __Serial__ will also add __many K__ to the build size, abruptly breaking the 16k limit. (One Serial.println() and you've used 15.5k!) Actually, I'm not sure it's actually (just) working even then.
